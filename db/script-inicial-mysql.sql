...
CREATE TABLE IF NOT EXISTS cupones (
  ...
  descuento float DEFAULT 0 COMMENT 'descuento representado en porcentaje '
) ;
...
ALTER TABLE ARTICULOS ADD CONSTRAINT UN_articulos_codigo unique index (CODIGO);
...
#datos socios
insert into socios(nombre, apellido,email,fecha_alta) values('carlos','lopez','email@email.com',curdate());
